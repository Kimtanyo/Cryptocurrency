...
# 这里还需要思考一下如何在波峰上面标出pink point来辅助观察pattern
...
for(stock_name in dataName){
  ...
  assign(p[i], remainder(close_date_trans_stl) %>% autoplot(main=paste("Remainders of",stock_name, "from STL",sep=" "), ylab="remainders",xlab="date"))
}
grid.arrange(p1,p2,p3,p4,p5,p6, ncol=1, nrow=6)
